...
import { BiBus, BiShareAlt, BiSolidLike, BiSolidPlane, BiSolidStar } from 'react-icons/bi'
...
const TourDetail = ({ data }: any) => {
        return (
                <div className="w-full p-5 rounded-xl">
                        <h2 className="mb-3 text-[color:var(--primary-color)] text-4xl font-bold">{data.name}</h2>
                        <div className="flex gap-12">
                                <div className="w-2/3">
                                        ...
                                        <div className="flex justify-between items-center bg-gray-100 rounded-sm p-5">
                                                ...
                                                <div className='flex flex-col justify-center items-center gap-1'>
                                                        ...
                                                        <div className="flex gap-2 text-xs">
                                                                <BiSolidStar /><BiSolidStar /><BiSolidStar /><BiSolidStar /></div>
                                                </div>
                                        </div>
                                        ...
                                        <div className="bg-red-100 rounded-sm px-5 py-2 mt-4">{data.numberOfGuest}</div>
                                        <div className="bg-white rounded-sm p-4 drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] mt-4">
                                                <div className="mt-4">
                                                        <div className="flex justify-between items-center">
                                                                <h2 className="text-3xl font-medium text-[#003C71]">{data.name}</h2>
                        ...
                        {/* Tour gợi ý */}
                        <div className="bg-white rounded-sm p-4 drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] border mt-4">
