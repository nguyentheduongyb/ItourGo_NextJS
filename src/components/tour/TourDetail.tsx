...
import TourRecommend from './TourRecommend';
                ...
                <div className="">
                        <div className="container w-full py-5 md:p-5 rounded-xl">
                                ...
                                <div className="space-y-1">
                                        <h1 className="md:mb-3 text-[color:var(--primary-color)] text-2xl md:text-4xl line-clamp-2 font-medium md:font-bold">{data.name}</h1>
